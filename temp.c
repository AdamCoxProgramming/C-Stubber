...
extern float32_t  Analysis_Calculate_Probability_Original( uint16_t );

void test_analysis( void )
{
    Unity.TestFile = __FILE__;
    
    RESET_FAKE(Analysis_Calculate_Probability);
    ...
    Analysis_Calculate_Probability_fake.custom_fake = Analysis_Calculate_Probability_Original;
